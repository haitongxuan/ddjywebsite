...
using DTcms.WebApi.Providers;
using DTcms.WebApi.Results;
...
namespace DTcms.WebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<ManageInfoViewModel> GetManageInfo(string returnUrl, bool generateState = false)
        {
            ...
            foreach (UserLoginIntPk linkedAccount in user.Logins)
            {
                logins.Add(new UserLoginInfoViewModel
                {
                    LoginProvider = linkedAccount.login_provider,
                    ProviderKey = linkedAccount.provider_key
                });
            }
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = ApplicationOAuthProvider.CreateProperties(user.user_name);
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { user_name = model.Email, email = model.Email };
