...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#cbIsItems").on("click", function () {
                if ($(this).prop("checked") == true) {
                    $("#div_item_channel_id").show();
                }
                else {
                    $("#div_item_channel_id").hide();
                }
            });
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-single-checkbox">
                        <asp:CheckBox ID="cbIsItems" runat="server" />
                    </div>
                    <span class="Validform_checktip">*开启明细需选择明细频道</span>
                </dd>
            </dl>
            <dl id="div_item_channel_id" runat="server" style="display: none">
                <dt>明细频道选择</dt>
                <dd>
                    <div class="rule-multi-radio">
                        <asp:RadioButtonList runat="server" ID="rblItemChannel" />
                        <span class="Validform_checktip">*开启明细需选择明细频道</span>
                    </div>
                </dd>
            </dl>
