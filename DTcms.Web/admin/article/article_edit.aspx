    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".item-btn").click(function () {
                showItemDialog(<%=item_channel_id%>);
            });
        ...
        function showItemDialog(id) {
            var d = top.dialog({
                ...
                padding: 0,
                title: "选择<%=itemTitle%>",
                url: 'dialog/dialog_item_article.aspx?channel_id=' + id
            }).showModal();
            //将容器对象传进去
            d.data = $("#item_article_box");
        }
        //初始化会员组价格窗口
...
<body class="mainbody">
    <form id="form1" runat="server">
      ...
      <asp:Label ID="div_sell_price_tip" runat="server" CssClass="Validform_checktip" />
            ...
            <dl runat="server" id="div_item_container" visible="False">
                <dt>增加选择明细
                </dt>
                <dd>
                    <div>
                        <a class="icon-btn add item-btn"><span>设置明细</span></a>
                        <div class="table-container" style="padding-top: 10px;">
                            <asp:HiddenField ID="hide_item_article_list" runat="server" />
                            <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="82%">
                                <thead>
                                    <tr>
                                        <th width="20%">缩略图</th>
                                ...
                                <tbody id="item_article_box">
                                    <asp:Repeater ID="rptItemArticle" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td align="center">
                                                ...
                                                <td align="center">
                                                    <input type="text" name="item_article_title" maxlength="10" class="td-input" value="<%#Eval("item_title")%>" /></td>
                                                <td align="center">
                                                    <input type="text" name="item_article_sort_id" maxlength="10" class="td-input" value="<%#Eval("sort_id")%>" onkeydown="return checkForFloat(this,event);" /></td>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
